...
-- ============================================================================
-- Password hashes:
-- admin123 = $2a$10$2QakONQqxZfpi5QhTH/AR.PFoaL9talll2u3Nym4uK3g9/qP/X/UW
...
VALUES ('admin', '$2a$10$2QakONQqxZfpi5QhTH/AR.PFoaL9talll2u3Nym4uK3g9/qP/X/UW', 'Administrator', 'admin@company.com', 'admin', NOW(), NOW());
...
VALUES
-- Employee 1 (John Doe) - 12 leave records
...
-- Employee 2 (Nguyễn Văn A) - 10 leave records
...
-- Employee 3 (Trần Văn B) - 8 leave records
...
VALUES
-- Employee 1 - January 2026 (20 working days)
...
-- Show employee with details
-- SELECT e.id, e.employee_id, e.first_name, e.last_name, e.department, e.position, e.hire_date, u.username 
-- FROM employees e JOIN users u ON e.user_id = u.id;

-- Show leaves per employee
-- SELECT e.first_name, e.last_name, COUNT(*) as total_leaves, 
...
-- SELECT e.first_name, e.last_name, COUNT(*) as total_expenses, SUM(exp.amount) as total_amount
-- FROM expenses exp JOIN employees e ON exp.employee_id = e.id
